...
/**
 * Route error boundary for /race-picker — catches uncaught exceptions
 * (bugs), not the typed DB-error path already handled inline in
 * page.tsx. T16 (Spec C3).
 */
export default function RacePickerError({
  unstable_retry,
}: {
